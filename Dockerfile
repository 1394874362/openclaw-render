...
# Base image ends with USER node; switch to root for setup and runtime
USER root

COPY patch-bash-default.js /tmp/patch-bash-default.js
RUN node /tmp/patch-bash-default.js && rm -f /tmp/patch-bash-default.js
